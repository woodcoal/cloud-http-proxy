...
public class ProxyConfig {
     ...
     */
	public List<string> AllowedMethods { get; set; } = ["GET", "POST", "PUT", "DELETE", "HEAD", "OPTIONS", "PATCH"];
     ...
     */
	public Dictionary<string, string> UrlShortcuts { get; set; } = [];
...
public class ReplaceRule {
	...
	/**
     * 属性名称：Host
     * 功能描述：指定域名：如果设置了此属性，仅当目标域名匹配时才执行替换规则
     */
